...

{
  ...
  if ((_DAT_008035ec & 8) == 0) {
    ...
    param_system_mode_flag.status_register = (word)((ulonglong)uVar3 >> 0x20);
  }
  else {
    param_system_mode_flag.status_register = _DAT_00806f9e;
  }
  ...
  param_system_mode_flag.status_register = uVar1 + param_system_mode_flag.status_register;
  return uVar2;
}
...
{
  if (param_system_mode_flag.status_register < _DAT_0080d494) {
    _DAT_0080d494 = param_system_mode_flag.status_register;
    _DAT_0080d496 = 0x10;
  }
  return;
}
...

{
  ...
  if ((((diagnostic_mode_status == 7) || (diagnostic_mode_status == 3)) ||
    ...
    sVar6 = _DAT_00809d04;
    if (diagnostic_mode_status != sensor_data_buffer._146_2_) {
    ...
    if (_DAT_00809d2a == 1) {
      ...
      sVar5 = _DAT_00809cc6;
            ...
            (diagnostic_mode_status == sensor_data_buffer._146_2_)) {
      _DAT_00809d00 = 0;
      sVar7 = _DAT_00809d08;
      sVar5 = _DAT_00809d0a;
    }
  ...
  sensor_data_buffer[0x92] = diagnostic_mode_status._0_1_;
  sensor_data_buffer[0x93] = (undefined1)diagnostic_mode_status;
  return;
}
    ...
    if (DAT_0080d407 < 0x59) {
      if (DAT_0080d407 < 0x54) {
        if (DAT_0080d407 == 2) {
          ...
          if (param_system_mode_flag.system_mode == 10) {
            bVar5 = 0x80;
          }
          else {
            bVar5 = 0;
...

{
  ...
  if ((param_system_mode_flag.system_mode == 2) || (param_system_mode_flag.system_mode == 1)) {
    _DAT_0080cff6 = activeParamReadFunction();
  }
  else if ((param_system_mode_flag.system_mode == 0xb) ||
          (param_system_mode_flag.system_mode == 0xc)) {
  ...
  if ((short)(param_scale_factor - param_ref_base.base_reference) < 1) {
    param_table_main.param_table_2 = 0;
    return;
  }
  ...
  param_table_main.param_table_2 = (word)uVar1;
  if (32000 < param_table_main.param_table_2) {
    param_table_main.param_table_2 = 32000;
  }
  return;
}
...

{
  ...
  if ((short)(param_scale_factor - param_ref_base.base_reference) < 1) {
    param_table_main.param_table_1 = 0;
    return;
  }
  ...
  param_table_main.param_table_1 = (word)uVar1;
  if (32000 < param_table_main.param_table_1) {
    param_table_main.param_table_1 = 32000;
  }
  return;
}
...

{
  ...
  if ((int)(uVar3 - uVar2) < 1) {
    param_table_main.param_table_3 = 0;
    return;
  }
  ...
  param_table_main.param_table_3 = (word)uVar2;
  if (32000 < param_table_main.param_table_3) {
    param_table_main.param_table_3 = 32000;
  }
  return;
}
...

{
  ...
  if ((int)((uint)fsmxthfl_calc_input - (uint)param_ref_base.base_reference) < 1) {
    param_table_main.param_table_4 = 0;
    return;
  }
  if ((short)(param_scale_factor - param_ref_base.base_reference) < 1) {
    param_table_main.param_table_4 = 0;
  ...
  uVar1 = param_address_calc(((uint)fsmxthfl_calc_input - (uint)param_ref_base.base_reference) *
                             0x6400,CONCAT22(param_scale_factor - param_ref_base.base_reference,
                                             (short)((uint)unaff_D2 >> 0x10)));
  param_table_main.param_table_4 = (word)uVar1;
  if (32000 < param_table_main.param_table_4) {
    param_table_main.param_table_4 = 32000;
  }
  return;
}
...

{
  ...
  uVar3 = _DAT_0080cfec;
  param_table_main.calculated_1 = param_interpolate(CONCAT22(_DAT_0080cfec,uVar4));
  uVar2 = _DAT_0080cfee;
  param_table_main.calculated_2 = param_interpolate(CONCAT22(_DAT_0080cfee,uVar3));
  uVar3 = _DAT_0080cff0;
  param_table_main.calculated_3 = param_interpolate(CONCAT22(_DAT_0080cff0,uVar2));
  uVar2 = _DAT_0080cff2;
  param_table_main.calculated_4 = param_interpolate(CONCAT22(_DAT_0080cff2,uVar3));
    ...
    if (_DAT_0080c810 == 8) {
      ...
      if (uVar1 == 0) {
        if (_DAT_0080c810 == 4) {
          ...
          if (((param_system_mode_flag.system_mode == 0xb) && (_DAT_0080d496 == 0x14)) ||
             (uVar1 = _DAT_00809652, _DAT_00809652 < _DAT_0080d494)) {
            _DAT_0080c9a6 = param_system_mode_flag.system_mode;
...

{
  ...
  sVar1 = _DAT_0080cc3c;
  if (param_system_mode_flag.system_mode == 0xc) {
...

{
  ...
  if ((bVar3 < 0xf0) && (bStack_5 != 0xff)) {
    if (diagnostic_message_state.message_type == 0) {
      diagnostic_message_state.message_type = 1;
      diagnostic_message_state.processing_state = bStack_5;
      diagnostic_message_state.param_request = uVar4 & 0xff00;
      diagnostic_message_state._8_2_ = *(undefined2 *)(param_1 + 1);
      diagnostic_message_state.response_buffer._0_1_ =
      ...
      _DAT_00800f4c = 8;
      _DAT_00800f46 = 0x37;
      _diagnostic_response_buffer = *(byte **)((int)param_1 + 10);
      pbVar5 = _DAT_00800f4e + 1;
      *_DAT_00800f4e = 0x10;
      uVar2 = diagnostic_message_state._8_2_;
      bStack_7 = diagnostic_message_state.destination_address;
      *pbVar5 = bStack_7;
      local_8 = SUB21(uVar2,1);
      puVar1[2] = local_8;
      puVar1[3] = diagnostic_message_state.response_buffer._0_1_;
      puVar1[4] = 0xff;
      puVar1[5] = 0;
      puVar1[6] = bVar3;
      puVar1[7] = 0;
      sendJ1939SingleFrame(_DAT_00800f48);
      if (diagnostic_message_state.priority == 0) {
        *_diagnostic_response_buffer = 0x12;
        _DAT_00800f48 = *param_1 & 0xff00ffff | 0xeb0000;
      }
      else {
        *_diagnostic_response_buffer = diagnostic_message_state.priority;
        diagnostic_message_state.message_type = 0;
      }
    }
    else {
...

{
  ...
  if ((((diagnostic_message_state.message_type == 1) &&
       (*(byte *)(param_1 + 3) == diagnostic_message_state.processing_state)) &&
      (bVar1 <= diagnostic_message_state.response_buffer._0_1_)) &&
     (local_6 == diagnostic_message_state.param_request)) {
    bVar2 = *(byte *)(*(int *)(param_1 + 6) + 1);
    if (bVar2 == 0) {
      _DAT_00800f46 = 0x37;
    }
    else {
      diagnostic_message_state.response_buffer._1_1_ = bVar1;
      diagnostic_message_state.data_length = bVar2;
      if ((int)(uint)diagnostic_message_state.response_buffer._0_1_ <
          (int)((uint)bVar2 + (uint)bVar1 + -1)) {
        diagnostic_message_state.data_length =
             (diagnostic_message_state.response_buffer._0_1_ - bVar1) + 1;
      }
    }
  }
  return;
...

{
  ...
  if ((diagnostic_message_state.message_type == 1) &&
     (diagnostic_message_state.processing_state == *(byte *)(param_1 + 3))) {
    local_6 = (ushort)*(byte *)(*(int *)(param_1 + 6) + 6) << 8;
    if (local_6 == diagnostic_message_state.param_request) {
...

{
  ...
  bVar6 = diagnostic_message_state.data_length;
  bVar3 = (byte)diagnostic_message_state.response_buffer;
  ...
  if (diagnostic_message_state.data_length < 0xb) {
    diagnostic_message_state.data_length = 0;
    _DAT_00800f46 = 0x70;
  }
  else {
    bVar6 = 10;
    diagnostic_message_state.response_buffer._1_1_ =
         (byte)diagnostic_message_state.response_buffer + 10;
    diagnostic_message_state.data_length = diagnostic_message_state.data_length - 10;
  }
  ...
  while( true ) {
    ...
    if (bVar3 == diagnostic_message_state.response_buffer._0_1_) {
      bVar2 = (diagnostic_message_state.destination_address - cVar4) + 1;
    ...
    *_DAT_00800f4e = bVar3;
    ...
    sendJ1939SingleFrame(_DAT_00800f48);
    if (diagnostic_message_state.priority != 0) break;
...

{
  ...
  if ((param_system_mode_flag.system_mode == 0xb) || (current_engine_param < _DAT_0080d096)) {
    ...
    if (((int)((int)_DAT_008087d6 + (uint)_DAT_0080d092) < (int)(uint)current_engine_param) &&
      ...
      if (param_system_mode_flag.system_mode == 0xb) {
...

{
  ...
  if ((param_system_mode_flag.system_mode == 0xb) && (_DAT_0080d076 == 1)) {
...

{
  ...
  pwVar2 = &param_ref_base.scale_factor;
  bVar1 = 0;
...

{
  ...
  DAT_00803037 = (char)(param_table_main.param_table_2 >> 8) + '}';
  param_lookup_1();
  DAT_00803038 = (char)(param_table_main.param_table_1 >> 8) + '}';
...
LAB_0002a4ea:
  ...
  param_lookup_2();
  DAT_00803050 = (undefined1)(param_table_main.param_table_3 >> 8);
...

{
  ...
  param_lookup_3();
  can_param_msg_buf_1 = (char)(param_table_main.param_table_4 >> 8) + 0x7d;
...

{
  ...
  if (bVar1 == 0) {
    ...
    DAT_00803080 = (char)(param_table_main.calculated_1 >> 8) + '}';
    ...
    DAT_00803083 = (char)(param_table_main.calculated_2 >> 8) + '}';
    ...
    DAT_00803086 = (char)(param_table_main.calculated_3 >> 8) + '}';
    ...
    DAT_00803089 = (char)(param_table_main.calculated_4 >> 8) + '}';
    ...
    uVar2 = param_table_main.calculated_1;
    for (pwVar3 = &param_table_main.calculated_2;
...

{
  ...
  FUN_0002da0e();
  FUN_0002db10();
  if (((param_system_mode_flag.system_mode == 7) || (param_system_mode_flag.system_mode == 8)) ||
     (param_system_mode_flag.system_mode == 9)) {
    _DAT_00803206 = param_system_mode_flag.system_mode;
  }
  switch(param_system_mode_flag.system_mode) {
  case 9:
    if ((_DAT_0080969a == 0) ||
    ...
    if ((((_DAT_00809696 == _DAT_00809698) &&
      ...
      param_system_mode_flag.system_mode = 10;
      FUN_0002d210();
      return;
    }
...

{
  ...
  if (param_system_mode_flag.system_mode == 9) {
  ...
  if ((_DAT_008096b8 == 0) && (param_system_mode_flag.system_mode == 9)) {
    _DAT_008096c4 = 0;
  }
...

{
  ...
  if ((param_system_mode_flag.system_mode == 9) || (param_system_mode_flag.system_mode == 10)) {
    if (_DAT_008096ee == 1) {
      FUN_0002d210();
    }
    else {
  ...
  _DAT_0080326a = param_system_mode_flag.system_mode;
  FUN_0002c7e0();
...

{
  ...
  if ((_DAT_008035da & 0x40) == 0) {
    ...
    if (((((((DAT_0080bdcc & 0x10) == 0) || (uVar4 = _DAT_008096f8, _DAT_008096f8 < _DAT_00807944))
      ...
      if ((_DAT_00809d4c < 0xc) || (param_system_mode_flag.system_mode == 9)) {
        bVar5 = false;
      }
      else {
        bVar5 = true;
...
{
  if (((_DAT_00803342 == 9) && (param_system_mode_flag.system_mode == 8)) &&
  ...
  if (((_DAT_00809652 < _DAT_00803340) && (param_system_mode_flag.system_mode == 8)) &&
     ((_DAT_008096aa == 0 || (_DAT_0080725c != 0)))) {
    _DAT_00809652 = _DAT_00803340;
  }
  _DAT_00803342 = param_system_mode_flag.system_mode;
...

{
  ...
  if (uVar1 < 0x10) {
    ...
    case 0xd:
      uVar3 = 0;
      _DAT_00809a36 = (ushort)((uint)param_table_main.param_table_2 * 0x50 >> 8);
      break;
    case 0xe:
    case 0xf:
  ...
  if (((_DAT_00803880 == 0xe) || (_DAT_00803880 == 0xf)) &&
     (((param_system_mode_flag.system_mode == 9 || (param_system_mode_flag.system_mode == 10)) ||
      (((_DAT_0080969a == 1 && (param_system_mode_flag.system_mode == 0xc)) && (_DAT_00809d4c < 0xc)
       ))))) {
